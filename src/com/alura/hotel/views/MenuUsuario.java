...
public class MenuUsuario extends JFrame {
	private static final long serialVersionUID = -8076476314382137155L;
	
	private JPanel contentPane;
	
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/resources/aH-40px.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(MenuUsuario.class.getResource("/resources/menu-img.png")));
		lblNewLabel.setBounds(-56, 0, 741, 471);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/resources/Ha-100px.png")));
		lblNewLabel_2.setBounds(724, 32, 104, 107);
		contentPane.add(lblNewLabel_2);
		
		JButton btnReserva = new JButton("");
		btnReserva.setIcon(new ImageIcon(MenuUsuario.class.getResource("/resources/reservas.png")));
		...
		btnSalir.setIcon(new ImageIcon(MenuUsuario.class.getResource("/resources/cerrar-sesion 32-px.png")));
		...
		btnBusqueda.setIcon(new ImageIcon(MenuUsuario.class.getResource("/resources/busqueda.png")));
